...
.PHONY: all help clean test cpu cuda cuda-spark cuda-generic cuda-regression strix-halo rocm qwen36-check qwen36-check-q4xl qwen36-check-iq2xxs qwen36-check-v0 qwen36-plan qwen36-runtime-dump qwen36-oracle qwen36-v0-quantize qwen36-v0-quant-lib qwen36-c-moe-replay qwen36-c-linear-replay qwen36-c-linear-conv-replay qwen36-c-linear-core-replay qwen36-c-linear-norm-replay qwen36-c-linear-layer-stub qwen36-c-linear-layer-full qwen36-c-linear-layer-weight qwen36-c-root qwen36-c-root-q8 qwen36-c-decoder-layer qwen36-c-decoder-layer-weight qwen36-c-two-decoder-layers qwen36-c-two-decoder-layers-weight qwen36-c-decoder-chain-weight qwen36-c-prefix-q8-chain-dynamic qwen36-c-prefix-q8-chain-live qwen36-live-contract-worker qwen36-owned-session-worker qwen36-unified-owned-worker qwen36-unified-owned-worker-rocm qwen36-c-full-layer-q8-dynamic qwen36-direct-hybrid-contract-check qwen36-gpu-oracle-scaffold qwen36-gpu-blk0-ffn-q8-oracle qwen36-gpu-blk0-dynamic-q8-oracle qwen36-gpu-hybrid-layer-q8-dynamic qwen36-gpu-prefix-q8-chain-dynamic qwen36-gpu-full-layer-q8-dynamic qwen36-gpu-full-layer-worker qwen36-fixture-blk0-worker
...
help:
	...
	@echo "  make qwen36-c-prefix-q8-chain-live Build the prompt-agnostic Qwen3.6 live-contract prefix chain"
	@echo "  make qwen36-live-contract-worker Build the persistent prompt-agnostic Qwen3.6 live-contract worker"
	@echo "  make qwen36-owned-session-worker Build the native Qwen3.6 owned-session coordinator"
	@echo "  make qwen36-unified-owned-worker Build the unified owned-worker scaffold"
	@echo "  make qwen36-unified-owned-worker-rocm Build the unified owned-worker with in-process ROCm full-layer support"
	...
	@echo "  make qwen36-gpu-full-layer-worker Build the persistent Qwen3.6 GPU full-attention worker"
...
qwen36_gpu_full_layer_worker.o: qwen36_gpu_full_layer_worker.c
	$(CC) $(CFLAGS) -c -o $@ qwen36_gpu_full_layer_worker.c
...
qwen36-c-prefix-q8-chain-live: qwen36_c_prefix_q8_chain_live.o qwen36_35a3b_q8.o qwen36_gguf.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

qwen36-live-contract-worker: qwen36_live_contract_worker.o qwen36_35a3b_q8.o qwen36_gguf.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
