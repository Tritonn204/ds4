#ifndef QWEN36_35A3B_Q4XL_H
#define QWEN36_35A3B_Q4XL_H

#include "qwen36_gguf.h"

#define QWEN36_35A3B_Q4XL_BLOCK_COUNT 40

typedef enum qwen36_35a3b_q4xl_layer_kind {
    QWEN36_Q4XL_LAYER_KIND_HYBRID_SSM = 1,
    QWEN36_Q4XL_LAYER_KIND_FULL_ATTENTION = 2,
} qwen36_35a3b_q4xl_layer_kind;

typedef struct qwen36_35a3b_q4xl_layer {
    qwen36_35a3b_q4xl_layer_kind kind;
...
} qwen36_35a3b_q4xl_layer;

typedef struct qwen36_35a3b_q4xl_model {
    ...
    qwen36_35a3b_q4xl_layer layers[QWEN36_35A3B_Q4XL_BLOCK_COUNT];
    uint32_t hybrid_layer_count;
    uint32_t full_attn_layer_count;
} qwen36_35a3b_q4xl_model;
